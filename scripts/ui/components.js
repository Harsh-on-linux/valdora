 ...
 * Reusable factory functions for DOM elements.
 */
 ...
 * @param {'sm'|'md'} [options.size='md'] - Button size.
 * @param {function} [options.onClick] - Click callback.
 * @returns {HTMLButtonElement} The created button element.
 */
export function createConsoleButton({ label, icon, variant, size = 'md', onClick }) {
