...
export const LEVELS = [
  {
    ...
    targetScore: 3000,
    scoreThresholds: { star1: 800, star2: 1800, star3: 3000 },
    rewardStars: 3,
    hazardType: 'NONE',
  ...
  },
  {
    ...
    targetScore: 7000,
    scoreThresholds: { star1: 1800, star2: 4200, star3: 7000 },
    rewardStars: 3,
  ...
  },
  {
    ...
    targetScore: 8500,
    scoreThresholds: { star1: 2400, star2: 5200, star3: 8500 },
    rewardStars: 3,
  ...
  },
  {
    ...
    targetScore: 12000,
    scoreThresholds: { star1: 3200, star2: 7500, star3: 12000 },
    rewardStars: 3,
  ...
  },
  {
    ...
    targetScore: 10500,
    scoreThresholds: { star1: 3500, star2: 7000, star3: 10500 },
    rewardStars: 3,
  ...
  },
  {
    ...
    targetScore: 9000,
    scoreThresholds: { star1: 2500, star2: 5500, star3: 9000 },
    rewardStars: 3,
  ...
  },
  {
    ...
    targetScore: 15500,
    scoreThresholds: { star1: 4500, star2: 9500, star3: 15500 },
    rewardStars: 3,
  ...
  },
  {
    ...
    targetScore: 18500,
    scoreThresholds: { star1: 5000, star2: 11500, star3: 18500 },
    rewardStars: 3,
  ...
  },
  {
    ...
    targetScore: 13000,
    scoreThresholds: { star1: 3500, star2: 8000, star3: 13000 },
    rewardStars: 3,
...
export function validateLevelsConfig() {
  ...
  for (let i = 0; i < LEVELS.length; i++) {
    ...
    const thresholds = lvl.scoreThresholds;
    if (lvl.waveCount < 1 || thresholds.star1 <= 0 || thresholds.star1 >= thresholds.star2 || thresholds.star2 >= thresholds.star3 || lvl.targetScore !== thresholds.star3) {
      console.error(`[levels.js] Invalid wave or score progression for sector ${lvl.id}`);
      return false;
    }
  }
